...
import sys
#
# sys.setcheckinterval(600000) # let this take up to 10 minutes
...
def requestPlayerMove(player, Category, guessed):
    while True:
        player = players[playerIndex]# we're going to keep asking the player for a move until they give a valid one
